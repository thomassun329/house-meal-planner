...
const styles = StyleSheet.create({
  ...
  summaryBtn: { backgroundColor: COLORS.white, borderRadius: 12, padding: 12, paddingHorizontal: 20, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 8, elevation: 3 },
  summaryBtnText: { fontSize: 14, fontWeight: '700', color: COLORS.primary },
